...
public class Gimnospermas extends Plantae{
	
	protected String nombreGrupo;
	protected String fruto;
	
	public Gimnospermas(String nombre, String nCientifico, double size, int canAgua, boolean exterior, String nombreGrupo, String fruto) {
